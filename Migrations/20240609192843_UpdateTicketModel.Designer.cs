...
namespace CourseProjectItems.Migrations
{
    ...
    [Migration("20240609192843_UpdateTicketModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseProjectItems.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("CourseProjectItems.Models.Ticket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CourseProjectItems.Models.Ticket", b =>
                {
                    b.HasOne("CourseProjectItems.Data.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CourseProjectItems.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
